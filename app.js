...
function _isWeeklyLike(p){if(!p)return false;if(p.id&&p.id.indexOf('wn-')===0)return true;var c=p.content||'';return /(^|\n)\s*(이번주|이번 주|일정|장소|셔틀버스|셔틀|기타)\s*[:：]/.test(c);}
