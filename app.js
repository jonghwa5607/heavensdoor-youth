...
function renderYearPlan(){var edit=_canEditPlan();_hydrateYP();
  ...
  if(thead)thead.innerHTML='<div style="display:flex;gap:6px;padding:9px 8px;font-size:11px;font-weight:800;color:var(--text-sub)"><span style="width:46px;flex-shrink:0;position:sticky;left:0;background:#fff;z-index:2">날짜</span><span style="flex:1.2">전례시기</span><span style="flex:.9">운영구분</span><span style="flex:1.2">교리</span><span style="flex:.9">교안담당</span><span style="flex:1.5">교리내용</span><span style="flex:1.2">전례부</span><span style="flex:1.2">성가대</span><span style="flex:1.2">비고</span><span style="flex:1.8">회의 안건</span></div>';
