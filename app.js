...
function paintTeacherHome(){
  try{
    ...
    if(thd)thd.textContent=isFull?(G.grade?G.grade+' 담당 · 전체 관리 권한이 있어요.':'전체 학년을 총괄합니다. 관리 탭에서 확인하세요.'):(G.grade||'담당')+' 담당 교사님, 오늘도 좋은 교리를 전해주세요 🙏';
  }catch(e){}
}
