...
function submitWeeklyNotice(){
  ...
  if(_wsdt){
    ...
    var _wp={id:id,title:title,content:body,cat:'notice',target:'all',grade:'all',authorId:G.id,authorName:G.displayName,comments:[],edited:false};
