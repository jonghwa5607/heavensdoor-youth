...
function buildEventCardHtml(e){
  ...
  if(_ec){
    if(yid){
      return `<div class="event-slide" ${clickAttr} style="${dim}"><div class="event-slide-img yt" style="position:relative"><img src="${_ec}">${play}${badge}</div><div class="event-yt-cap">▶ ${e.title}</div></div>`;
    }
