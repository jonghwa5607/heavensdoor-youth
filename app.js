...
function openAvatarFull(src){if(!src)return;var im=document.getElementById('avatar-full-img');if(!im)return;im.src=src;openModal('avatar-full-modal');}
function closeAvatarFull(){closeModal('avatar-full-modal');}
