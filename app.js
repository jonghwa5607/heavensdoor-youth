...
function setCalResponse(eid,val){const e=calEvents.find(e=>e.id===eid);if(!e)return;if(!e.responses)e.responses={};e.responses[G.id]=val;try{if(typeof flushSync==='function')flushSync();}catch(x){}renderCalDayEvents(selectedCalDate);showToast(val==='yes'?'참석으로 응답했어요':'불참으로 응답했어요');}
